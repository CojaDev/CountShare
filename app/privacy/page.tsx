        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>
              ...
              an account, create or share countdowns, and interact with other
              users. This may include your name, email address, profile
              information, and any content you choose to share.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>
              ...
              in operating our website and conducting our business. We may also
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>
              ...
              time by logging into your account settings. You can also opt-out
